 ...
 */
	...
	$related_posts_number = viva_get_option( 'tek-related-posts-number' );
	...
	if( $related_query->have_posts() ) : ?>
		<section class="related-posts">
		  <div class="container">
		    <?php if ( '' != viva_get_option( 'tek-related-posts-title' ) ) : ?>
		      <div class="related-title">
		        <h3><?php echo esc_html( viva_get_option( 'tek-related-posts-title' ) ); ?></h3>
		      </div>
		    <?php endif; ?>
